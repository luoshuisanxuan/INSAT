function [F,radiusa] = Fupdate(Rx,INSATsetting,iloopCnt)
    ...
    F11(1,3)=Rx.ve/rh/rh/clat;%N and E
    F11(2,3)=Rx.vn/rh/rh;%N and U
    F12 = eye(3);
    F13 = zeros(3,3);   
    F21=zeros(3,3);
    ...
    F22(3,2)=2*Rx.vn/rh;    
    F23 = antisymm(Rx.accel_L); %zeros(3,3);  
    F31 = zeros(3,3);
    F32 = zeros(3,3);
    ...
    F(4:6,10:12) = zeros(3,3); %Rx.C*Rx.est_DCMbn;   
    ...
    F(1,1)=0;F(2,2)=0;F(3,3)=0;F(4,4)=0;F(5,5)=0;F(6,6)=0;
    F(7,7)=0;F(8,8)=0;F(9,9)=0;F(16,16)=1;F(17,17)=0;
end