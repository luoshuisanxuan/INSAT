...
try
    ...
    settings.skipNumberOfSamples = edit2double(handles.editSkipNumberOfSamples);
...
set(handles.editSkipNumberOfSamples, 'String', num2str(handles.settings.skipNumberOfSamples));
