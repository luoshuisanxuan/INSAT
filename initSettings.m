...
settings.msToProcess        = 410000;        %[ms]
settings.ms                 = 1;
...
settings.dir                = 'F:\TEXBAT\postResult\ds6'; % F:\TEXBAT
settings.IF                 = 0; % 3.996e6;     % [Hz] 
settings.samplingFreq       = 25e6; % 16.369e6;   % [Hz]
settings.fileType           = 2;
settings.dataType           = 'int16'; 
settings.skipNumberOfSamples     = 0*settings.samplingFreq ;
settings.skipNumberOfBytes = settings.skipNumberOfSamples ;
...
settings.acqNonCohTime      = 5;                %[ms] 
% Threshold for the signal presence decision rule
settings.acqThreshold       = 4; %5.6;
...
settings.INSAT = 1;
settings.multiCorrOn = 1;
settings.multiCorrDistribution  =  -3:0.2:3;
%% Navigation solution settings ===========================================

% Period for calculating pseudoranges and position
settings.navSolRate         = 100;          %[Hz]
